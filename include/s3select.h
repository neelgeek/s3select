...
#define BOOST_BIND_ACTION(push_name) boost::bind(&push_name::operator(), g_##push_name, const_cast<s3select *>(&self), _1, _2)
  ...
  public:
    ...
    explicit csv_object(s3select *s3_query) : base_s3object(s3_query->get_scratch_area()),
    ...
    csv_object(s3select *s3_query, struct csv_defintions csv) : base_s3object(s3_query->get_scratch_area()),
                                                                m_skip_last_line(false),
                                                                m_s3_select(nullptr),
                                                                m_error_count(0),
                                                                m_extract_csv_header_info(false),
    ...
    csv_object() : base_s3object(nullptr),
                   m_skip_last_line(false),
                   m_s3_select(nullptr),
                   m_error_count(0),
                   m_extract_csv_header_info(false),
